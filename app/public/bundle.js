...
/***/ function(module, exports, __webpack_require__) {
	...
	var _hashchange = __webpack_require__(161);
	...
	var hash = new _hashchange2.default();
	hash.change = function (h) {
		switch (h) {
			case '':
				page = new _Index2.default('home');
				break;
			case 'home':
				page = new _Index2.default('home');
				break;
			case 'about':
				page = new _About2.default('about');
				break;
			default:
				page = new _NotFound2.default('404');
		}
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Page2 = __webpack_require__(2);
	...
	var Index = function (_Page) {
		...
		function Index(id) {
			...
			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Index).call(this, id));

			_this.target = document.querySelector('#content');
			_this.html = '<p>Este é o conteúdo da tela Index</p><br><a href="#about">Ir para about</a>';
			return _this;
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var idSymbol = Symbol();
	var htmlSymbol = Symbol();
	var contentSymbol = Symbol();
	var buildModule = function buildModule(id, content, target) {
		_reactDom2.default.render(_react2.default.createElement(Component, { id: id, content: content }), target);
	};
	...
	var Page = function () {
		...
		_createClass(Page, [{
			...
			set: function set(value) {
				this[contentSymbol] = value;
			}
		}, {
			key: 'html',
			set: function set(value) {
				this[htmlSymbol] = buildModule(this.id, value, this[contentSymbol]);
			}
		}]);
		...
		_createClass(Component, [{
			...
			value: function render() {
				return _react2.default.createElement(
					'div',
					{ className: 'module-holder', id: this.props.id },
					...
					_react2.default.createElement('br', null),
					_react2.default.createElement('div', { className: 'well', dangerouslySetInnerHTML: { __html: this.props.content } }),
					_react2.default.createElement(
						'h3',
						null,
						'Features do Ecmascript 2015',
						_react2.default.createElement('br', null),
						'utilizadas nesse exemplo:'
					),
					_react2.default.createElement(
						'ul',
						null,
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'a',
								{ href: 'http://es6-features.org/#ExpressionBodies', target: '_blank' },
								'Arrow functions'
							)
						),
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'a',
								{ href: 'http://es6-features.org/#SymbolType', target: '_blank' },
								'Symbols'
							)
						),
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'a',
								{ href: 'http://es6-features.org/#ValueExportImport', target: '_blank' },
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'a',
								{ href: 'http://es6-features.org/#ClassDefinition', target: '_blank' },
								'Classes'
							)
						),
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'a',
								{ href: 'http://es6-features.org/#StringInterpolation', target: '_blank' },
...
/***/ function(module, exports) {
	...
	var hash = '';
	var changeSymbol = Symbol();
	var treatURL = function treatURL() {
		return window.location.hash.split('#').pop();
	};
	var hashHandler = function hashHandler(fn) {
		fn(treatURL);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var About = function (_Page) {
		...
		function About(id) {
			...
			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(About).call(this, id));

			_this.target = document.querySelector('#content');
			_this.html = '<p>Este é o conteúdo da tela About</p><br><a href="#nao">Ir para 404</a>';
			return _this;
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NotFound = function (_Page) {
		...
		function NotFound(id) {
			...
			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(NotFound).call(this, id));

			_this.target = document.querySelector('#content');
			_this.html = '<p>Página não encontrada</p><br><a href="#">Ir para Página Inicial</a>';
			return _this;
		}
